...
const RegisterPage = ({ dispatch, users, existingUser }) => {
  ...
  //   if (form.checkValidity() === false || user.password !== user.rePassword) {
  ...
  //   // }
  //   navigate('/')
  //   console.info("submitHandler user.......... ", user)
  // };
  ...
  const submitHandler = async e => {
    ...
    if (!empty(allErrors)) {
      setErrors(allErrors);
      setValidated(true)
      console.info("submitHandler allErrors.......... ", allErrors)
    } else {
      setValidated(false)
      ...
      navigate('/login')
      console.info("submitHandler newUser.......... ", newUser)
    }
  };
